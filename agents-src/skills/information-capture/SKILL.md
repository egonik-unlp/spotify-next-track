...
question the leaderboard can't: two models can post the same {{primary_metric}}
...
and a `{{facts_file}}` note — spawn the **information-capture-analyst** agent
